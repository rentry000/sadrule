...
# 定义广告过滤器URL列表
$urlList = @(
"https://github.com/zachlagden/Pi-hole-Optimized-Blocklists/raw/refs/heads/main/lists/all_domains.txt",
"https://github.com/zachlagden/Pi-hole-Optimized-Blocklists/raw/refs/heads/main/lists/malicious.txt"
...
# 定义输出文件路径
$outputPath = "$PSScriptRoot/adblock_reject29.json"
